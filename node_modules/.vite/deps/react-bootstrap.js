...
var AlertLink = React16.forwardRef(({
  className,
  bsPrefix,
...
function getReactVersion() {
  const parts = React17.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var Fade = React18.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    ...props,
    onEnter: handleEnter,
    childRef,
    children: (status, innerProps) => React18.cloneElement(children, {
      ...innerProps,
...
var CloseButton = React19.forwardRef(({
  className,
  variant,
  "aria-label": ariaLabel = "Close",
  ...props
}, ref) => (0, import_jsx_runtime14.jsx)("button", {
  ref,
  type: "button",
...
var Alert = React20.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
  ...
  const alert = (0, import_jsx_runtime16.jsxs)("div", {
    role: "alert",
    ...
    children: [dismissible && (0, import_jsx_runtime15.jsx)(CloseButton_default, {
      onClick: handleClose,
  ...
  return (0, import_jsx_runtime15.jsx)(Transition2, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
...
var BreadcrumbItem = React22.forwardRef(({
  ...
  return (0, import_jsx_runtime18.jsx)(Component2, {
    ...
    children: active ? children : (0, import_jsx_runtime18.jsx)(LinkComponent, {
      ...linkProps,
      href,
      title,
      target,
...
var Breadcrumb = React23.forwardRef(({
  ...
  return (0, import_jsx_runtime19.jsx)(Component2, {
    ...
    ref,
    ...props,
    children: (0, import_jsx_runtime19.jsx)("ol", {
      ...listProps,
...
var ButtonToolbar = React26.forwardRef(({
  bsPrefix,
  className,
  role = "toolbar",
  ...props
...
var CardBody = React27.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardImg = React31.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var CardImgOverlay = React32.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardLink = React33.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "a",
  ...props
...
var CardSubtitle = React34.forwardRef(({
  className,
  bsPrefix,
...
var CardText = React35.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "p",
  ...props
...
var CardTitle = React36.forwardRef(({
  className,
  bsPrefix,
...
var Card = React37.forwardRef(({
  ...
  return (0, import_jsx_runtime32.jsx)(Component2, {
    ...
    children: body ? (0, import_jsx_runtime32.jsx)(CardBody_default, {
      children
    }) : children
  });
});
...
var CardGroup = React38.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function useUpdateEffect(fn2, deps) {
  const isFirst = (0, import_react23.useRef)(true);
...
function useWillUnmount(fn2) {
  ...
  (0, import_react25.useEffect)(() => () => onUnmount.current(), []);
}
...
function useTimeout() {
  ...
  const handleRef = (0, import_react26.useRef)();
...
var CarouselCaption = React39.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function map(children, func) {
  let index = 0;
  return React41.Children.map(children, (child) => React41.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React41.Children.forEach(children, (child) => {
    if (React41.isValidElement(child)) func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return React41.Children.toArray(children).some((child) => React41.isValidElement(child) && child.type === type);
}
...
var Carousel = React42.forwardRef(({
  ...
  const {
    ...
    onTouchMove,
    onTouchEnd,
    prevIcon = (0, import_jsx_runtime36.jsx)("span", {
      "aria-hidden": "true",
      className: "carousel-control-prev-icon"
    }),
    prevLabel = "Previous",
    nextIcon = (0, import_jsx_runtime36.jsx)("span", {
      "aria-hidden": "true",
  ...
  const nextDirectionRef = (0, import_react27.useRef)(null);
  const [direction, setDirection] = (0, import_react27.useState)("next");
  const [paused, setPaused] = (0, import_react27.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react27.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react27.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react27.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react27.useRef)();
  ...
  const handleEnter = (0, import_react27.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null || onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react27.useCallback)(() => {
    setIsSliding(false);
    onSlid == null || onSlid(renderedActiveIndex, slideDirection);
  }, [onSlid, renderedActiveIndex, slideDirection]);
  const handleKeyDown = (0, import_react27.useCallback)((event) => {
  ...
  const handleMouseOver = (0, import_react27.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null || onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react27.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null || onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react27.useRef)(0);
  const touchDeltaXRef = (0, import_react27.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react27.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react27.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react27.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react27.useRef)();
  (0, import_react27.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react27.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
    onSelect == null || onSelect(index, event);
  }), [indicators, numChildren, onSelect]);
  return (0, import_jsx_runtime37.jsxs)(Component2, {
    ref: elementRef,
    ...props,
    onKeyDown: handleKeyDown,
    ...
    children: [indicators && (0, import_jsx_runtime36.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime36.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime36.jsx)(TransitionWrapper_default, {
          in: isActive,
          onEnter: isActive ? handleEnter : void 0,
          onEntered: isActive ? handleEntered : void 0,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React42.cloneElement(child, {
            ...innerProps,
    ...
    }), controls && (0, import_jsx_runtime37.jsxs)(import_jsx_runtime38.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime37.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime36.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime37.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime36.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react28.useCallback)((...args) => {
...
var DropdownContext = React45.createContext(null);
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react32.useContext)(DropdownContext_default);
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react33.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react33.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react33.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react33.useState)(true);
  let value = (0, import_react33.useMemo)(() => ({
  ...
  return (0, import_react33.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react33.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react33.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react33.default).createElement((0, import_react33.default).Fragment, null, props.children);
  }
  return (0, import_react33.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react33.default).useId();
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react33.default)["useSyncExternalStore"] === "function") return (0, import_react33.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
...
function DropdownToggle({
  ...
  return (0, import_jsx_runtime42.jsx)(import_jsx_runtime42.Fragment, {
    children: children(props, meta)
  });
}
...
var DropdownItem = React48.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
...
var Context = (0, import_react36.createContext)(canUseDOM_default ? window : void 0);
...
function Dropdown({
  ...
  const context6 = (0, import_react37.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var DropdownContext2 = React50.createContext({});
...
var DropdownDivider = React51.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "hr",
  role = "separator",
...
var DropdownHeader = React52.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  role = "heading",
...
var DropdownItem2 = React53.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var DropdownItemText = React54.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var context5 = React56.createContext(null);
...
var DropdownMenu2 = React57.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
...
var DropdownToggle2 = React58.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var Dropdown2 = React59.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
...
var DropdownButton = React60.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
...
var FigureImage = React62.forwardRef(({
  className,
  fluid = true,
  ...props
...
var FigureCaption = React63.forwardRef(({
  className,
  bsPrefix,
...
var Feedback = React65.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormCheckInput = React67.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React68.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React69.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
...
var FormControl = React70.forwardRef(({
  bsPrefix,
  type,
  size: size2,
  htmlSize,
...
var FormFloating = React71.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React72.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
}, ref) => {
  const context6 = (0, import_react46.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var FormLabel = React73.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "label",
  bsPrefix,
  column = false,
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime67.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var FormRange = React74.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React75.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React76.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React77.forwardRef((props, ref) => (0, import_jsx_runtime71.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React78.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var InputGroupText = React80.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroup = React81.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react53.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react53.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react53.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react53.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react53.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react53.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react53.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react53.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React82.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose7(_ref, _excluded6);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime77.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function useTransition({
  ...
  const isInitialRef = (0, import_react54.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react54.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react54.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime78.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime78.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime78.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react55.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react55.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react55.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react55.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime79.jsx)("div", Object.assign({}, props)),
  ...
  const [exited, setExited] = (0, import_react55.useState)(!show);
  const lastFocusRef = (0, import_react55.useRef)(null);
  (0, import_react55.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react55.useRef)();
  const removeKeydownListenerRef = (0, import_react55.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime79.jsx)("div", Object.assign({}, dialogProps, {
    children: React84.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime79.jsx)(import_jsx_runtime79.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime79.jsxs)(import_jsx_runtime79.Fragment, {
...
var ModalBody = React85.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React86.createContext({
...
var ModalDialog = React87.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React88.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React89.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context6 = (0, import_react56.useContext)(ModalContext_default);
...
var ModalHeader = React90.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
  ...
  return (0, import_jsx_runtime85.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var ModalTitle = React91.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime87.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal2 = React92.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react57.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react57.useState)(false);
  const waitingForMouseUpRef = (0, import_react57.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react57.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react57.useRef)(null);
  const [modal, setModalRef] = useCallbackRef();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react57.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react57.useCallback)((backdropProps) => (0, import_jsx_runtime87.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime87.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime87.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime87.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime87.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var NavItem = React93.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React94.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav = React95.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react58.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react58.useContext)(CardHeaderContext_default);
  if (navbarContext) {
  ...
  return (0, import_jsx_runtime90.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
...
var NavbarBrand = React96.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React97.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context6 = (0, import_react59.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime92.jsx)(Collapse_default, {
...
var NavbarToggle = React98.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react60.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime93.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime93.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react61.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react62.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React99.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React100.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime95.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React100.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React101.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
  ...
  return (0, import_jsx_runtime96.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var OffcanvasTitle = React102.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime98.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition2(props) {
  return (0, import_jsx_runtime98.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React103.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const modalManager = (0, import_react63.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react63.useState)(false);
  const handleHide = useEventCallback(onHide);
  ...
  const renderBackdrop = (0, import_react63.useCallback)((backdropProps) => (0, import_jsx_runtime98.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames76.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime98.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime100.jsxs)(import_jsx_runtime99.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime98.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime98.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React104.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context6 = (0, import_react64.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
    context6 == null || context6.onToggle == null || context6.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime101.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React105.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React106.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  const handleCollapse = (0, import_react65.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react65.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime103.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React107.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime105.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames79.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime104.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime104.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React108.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const [exited, setExited] = (0, import_react67.useState)(!props.show);
...
var PopoverHeader = React109.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React110.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React112.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime109.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime108.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime108.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React113.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime111.jsxs)("div", {
    ...
    ...props,
    children: [(0, import_jsx_runtime110.jsx)("div", {
      className: "tooltip-arrow",
      ...arrowProps
    }), (0, import_jsx_runtime110.jsx)("div", {
...
var Overlay2 = React114.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react69.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react69.useState)(null);
  ...
  return (0, import_jsx_runtime112.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React114.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react70.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react70.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React115.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react70.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react70.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react70.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react70.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react70.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react70.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react70.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime115.jsxs)(import_jsx_runtime114.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react70.cloneElement)(children, triggerProps), (0, import_jsx_runtime113.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React116.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime116.jsx)("li", {
    ref,
    style: style2,
    ...
    children: (0, import_jsx_runtime117.jsxs)(Component2, {
      className: (0, import_classnames85.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime116.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React116.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime117.jsxs)(PageItem, {
    ...props,
    ref,
    children: [(0, import_jsx_runtime116.jsx)("span", {
      "aria-hidden": "true",
...
var Pagination = React117.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime118.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React118.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime119.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React119.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime120.jsx)(Component2, {
    ...placeholderProps,
    ref
  });
});
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime121.jsx)("div", {
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime121.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React120.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime121.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react71.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React121.forwardRef(({
  ...
  return (0, import_jsx_runtime122.jsx)("div", {
    ...
    children: React121.Children.only(children)
  });
});
...
var Row = React122.forwardRef(({
  ...
  return (0, import_jsx_runtime123.jsx)(Component2, {
    ref,
    ...props,
...
var Spinner = React123.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React124.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime126.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime125.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime125.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime125.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react72.useContext)(TabContext_default);
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context6, rest = _objectWithoutPropertiesLoose9(context6, _excluded22);
...
var TabPanel = React126.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime128.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime128.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime128.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime128.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime130.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React129.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
  ...
  return (0, import_jsx_runtime131.jsx)(Component2, {
    ref,
...
var TabPane = React130.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime132.jsx)(TabContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime132.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime132.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime132.jsx)(Component2, {
          ...rest,
          ref,
...
var Table = React131.forwardRef(({
  ...
  const table = (0, import_jsx_runtime133.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime134.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime134.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime135.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime134.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime134.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime134.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React133.forwardRef((props, ref) => (0, import_jsx_runtime136.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React134.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React135.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context6 = (0, import_react74.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
  ...
  return (0, import_jsx_runtime138.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames96.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime137.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React136.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
  ...
  return (0, import_jsx_runtime139.jsx)(Component2, {
    ref,
    className: (0, import_classnames97.default)(className, bsPrefix),
    ...props
  });
});
...
var Toast = React137.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime140.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames98.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime140.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime140.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React138.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime141.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames99.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop6 = () => void 0;
var ToggleButton = React139.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime144.jsxs)(import_jsx_runtime143.Fragment, {
    children: [(0, import_jsx_runtime142.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime142.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames100.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React140.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime145.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
      ...
      return React140.cloneElement(child, {
        type,
